...
def main():
    ...
    file_name = "/home/schuyler/Desktop/Honors_Thesis/data_sets/model_data/" + start_month + start_day + ".csv"


    with open('/home/schuyler/Desktop/master_data.csv', "rb") as master, open(file_name, 'wb') as test:
